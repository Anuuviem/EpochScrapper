...
_VRApvParts = [["PartGeneric","1"],["PartEngine","1"],["PartFueltank","1"],["PartGlass","1"]];
...
_VRApvParts select 0 set [1,_randMid];
_VRApvParts select 2 set [1,_randFlip];
_VRApvParts select 3 set [1,_randFlip];
_VRApvParts select 4 set [1,_randLow];
...
_spawnCrate addMagazineCargoGlobal [(_VRApvParts select 0) select 0, (_VRApvParts select 0) select 1];
_spawnCrate addMagazineCargoGlobal [(_VRApvParts select 1) select 0, (_VRApvParts select 1) select 1];
_spawnCrate addMagazineCargoGlobal [(_VRApvParts select 2) select 0, (_VRApvParts select 2) select 1];
_spawnCrate addMagazineCargoGlobal [(_VRApvParts select 3) select 0, (_VRApvParts select 3) select 1];