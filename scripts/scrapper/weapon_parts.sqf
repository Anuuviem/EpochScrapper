...
if ((_countMTur != 0) || (_countSTur != 0) || (_countBTur != 0) || (_countRTur != 0) || (_countLTur != 0) || (_countFTur != 0)) then { //if vehicle has any turrets, this will detect that and continue else, go to end of script
  ...
  if (_countBTur > 1) then {
    ...
    if (_countBTur == 1) then {		
      _vehBackTur = _vehBackTur select 0;		
      _convertArray = _convertArray + [_vehBackTur];		
    };
  };
  if (_countRTur > 1) then {
    ...
    if (_countRTur == 1) then {		
      _vehRightTur = _vehRightTur select 0;		
      _convertArray = _convertArray + [_vehRightTur];		
    };
  };
  if (_countLTur > 1) then {
    ...
    if (_countLTur == 1) then {		
      _vehLeftTur = _vehLeftTur select 0;		
      _convertArray = _convertArray + [_vehLeftTur];		
    };
  };
  if (_countFTur > 1) then {
    ...
    if (_countFTur == 1) then {		
      _vehFrontTur = _vehFrontTur select 0;		
      _convertArray = _convertArray + [_vehFrontTur];		
    };
  };
  ...
  for "_i" from 0 to (_countConvert - 1) do {
    ...
    _convPart = _convertArray select _i;
      switch (_convPart) do {
        ...
        case "2B14"                         : {_bagsArray = _bagsArray + ["2b14_82mm_TK_Bag_EP1","Tripod_Bag"];};
        ...
        case "M252"                         : {_bagsArray = _bagsArray + ["M252_US_Bag_EP1","Tripod_Bag"];};
        ...
        case "BAF_M240_veh"                 : {_wepsArray = _wepsArray + ["M240_DZ","Tripod_Bag"];};
        case "BAF_M240_veh_2"               : {_wepsArray = _wepsArray + ["M240_DZ","Tripod_Bag"];};
        //case "M3P"                        : {_wepsArray = _wepsArray + ["M3P"];};
        //case "KPVT"                       : {_wepsArray = _wepsArray + ["KPVT"];};
        case "KORD"                         : {_bagsArray = _bagsArray + ["KORD_TK_Bag_EP1","Tripod_Bag"];};
        case "M2"                           : {_bagsArray = _bagsArray + ["M2StaticMG_US_Bag_EP1","Tripod_Bag"];};
        ...
        case "AGS30"                        : {_bagsArray = _bagsArray + ["AGS_TK_Bag_EP1","Tripod_Bag"];};
        ...
        case "TOWLauncherSingle"            : {_bagsArray = _bagsArray + ["TOW_TriPod_US_Bag_EP1","Tripod_Bag"];};
        case "TOWLauncher"                  : {_bagsArray = _bagsArray + ["TOW_TriPod_US_Bag_EP1","Tripod_Bag"];};
        case "M197"                         : {_bagsArray = _bagsArray + ["M2StaticMG_US_Bag_EP1","Tripod_Bag"];};
        ...
        case "MK19"                         : {_bagsArray = _bagsArray + ["MK19_TriPod_US_Bag_EP1","Tripod_Bag"];};
        case "MK19BC"                       : {_bagsArray = _bagsArray + ["MK19_TriPod_US_Bag_EP1","Tripod_Bag"];};
        case "BAF_GMG"                      : {_bagsArray = _bagsArray + ["MK19_TriPod_US_Bag_EP1","Tripod_Bag"];};
